...
class Database:
    def __init__(self):
        db = psycopg2.connect(dbname='lab2', user='postgres', password='pshenokek16', host='localhost')
        self.cur = db.cursor()
        ...
        self.cur.execute(""" CREATE TABLE "ЗАДАЧА"
                            ...
                            "ЗАКАЗЧИК" character CHECK(LENGTH("ЗАКАЗЧИК") >=5 AND  LENGTH("ЗАКАЗЧИК") <=32),
                            "СФЕРА" integer,
                            "ИСПОЛНИТЕЛЬ" character CHECK( LENGTH("ИСПОЛНИТЕЛЬ") >=5 AND  LENGTH("ИСПОЛНИТЕЛЬ") <=32),
        ...
        self.cur.execute(""" CREATE TABLE "СФЕРА - IT"
                            ...
                            "ПРЕДСТАВИТЕЛЬ IT" character CHECK( LENGTH("ПРЕДСТАВИТЕЛЬ IT") >=5 AND  LENGTH("ПРЕДСТАВИТЕЛЬ IT") <=32),
